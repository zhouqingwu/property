...
<div class="container main_wrapper <?php print esc_html($wide_class); print esc_html('has_header_'.$logo_header_type.' '.$header_transparent_class); ?> ">
    ...
    <div class="master_header master_header_sticky <?php print esc_html($wide_class.' '.$header_transparent_class); ?>">
       ...
       <!--backtop-->
        ...
        <div class="header_wrapper  navbar-fixed-top customnav <?php echo 'header_'.$logo_header_type;?> ">
            <div class="header_wrapper_inside">
                
                <div class="logo miclogo" >
