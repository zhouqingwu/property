...
jQuery(document).ready(function ($) {
    ...
    $('#save_prop_design').click(function(){
       ...
       // content ='';
        sidebar_right=$('#property_page_sidebar_right .property_page_content_wrapper').html();
        sidebar_left=$('#property_page_sidebar_left .property_page_content_wrapper').html();
