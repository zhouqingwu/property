...
if( !function_exists('wpestate_save_property_page_design') ):
    function wpestate_save_property_page_design(){
        ...
        update_option('wpestate_property_page_sidebar_left',$sidebar_left);
        
        $sidebar_right=$_POST['sidebar_right'];
        update_option('wpestate_property_page_sidebar_right',$sidebar_right);
        
        /* 
        update_option('wpestate_property_page_content','');
        update_option('wpestate_property_page_sidebar_right','');
        update_option('wpestate_property_page_sidebar_left','');
       */
    }
 endif;   
