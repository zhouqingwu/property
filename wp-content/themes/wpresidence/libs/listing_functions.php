        ...
        if($show_no_features!='no'){
            foreach($feature_list_array as $checker => $value){
                    ...
                    if (esc_html( get_post_meta($post_id, $input_name, true) ) == 1) {
                         $return_string .= '<div class="listing_detail col-md-'.$colmd.'"><i class="fa fa-check"></i>' . trim($value) . '</div>';
                    }else{
                        $return_string  .=  '<div class="listing_detail col-md-'.$colmd.'"><i class="fa fa-times"></i>' . trim($value). '</div>';
                    }
              }
        }else{
