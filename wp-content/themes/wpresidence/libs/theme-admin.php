    ...
    <div id="wpestate_sidebar_menu">
        ...
        <div id="design_settings_sidebar" class="theme_options_sidebar" style="display:none;">
            <ul>
               ...
               <!-- <li data-optiontab="property_page__design_tab" class="">'.__('Property Page Desgin - BETA','wpestate').'</li> -->
            </ul>
        </div>
    ...
    print ' <div id="wpestate_wrapper_admin_menu"> 
                ...
                <div id="design_settings_sidebar_tab" class="theme_options_wrapper_tab" style="display:none">
                        ...
                        <div id="property_page__design_tab" class="theme_options_tab" style="display:none;" >
                            <h1>'.__('Property Page Design Tab','wpestate').'</h1>
                            <input type="submit" name="submit"  class="new_admin_submit new_admin_submit_right" value="'.__('Save Changes','wpestate').'" />
                            <div class="theme_option_separator"></div>';
...
function new_wpestate_theme_social_accounts(){
    ...
    <div class="option_row_explain">'.__('Zillow Api Key is required for theme Zillow Widget.','wpestate').'</div>    
...
function    new_wpestate_advanced_search_form(){
    ...
    <div class="option_row_explain">'.__('If yes, you can set your own custom fields in the max 8 spots available. See help for correct setup.','wpestate').'</div>    
        <select id="custom_advanced_search" name="custom_advanced_search">
            '.$custom_advanced_search_select.'
        </select> 
    </div>';
...
function new_wpestate_property_page_design_details(){
    ...
    print'<div class="estate_option_row">';
        ...
        $sidebar_right  = get_option('wpestate_property_page_sidebar_right',true);
        $sidebar_left   = get_option('wpestate_property_page_sidebar_left',true);

    
        print '<select id="property_page_design_sidebar">
                <option value="1">'.__('sidebar on the right','wpestate').'</option>
                <option value="2">'.__('sidebar on the left','wpestate').'</option>
                <option value="3">'.__('no sidebar','wpestate').'</option>
            </select>';
    
       /* print '<div id="property_page_tools">';
                print '<li class="prop_page_design_el original_el prop_row" id="prop_full_row">
                        <div class="col-prop-12 prop-columns">Row</div>
                        <div class="delete_design_el" style="display:none;"></div></li>';
            
        
        print'</div>';*/
        print '<div id="property_page_design_wrapper">';
            
                print '<div id="property_page_sidebar_left" class="elements_container" style="display:none;">
                <div class="property_page_content_wrapper">'. stripslashes($sidebar_left).'</div>
                <div class="add_me_new_row">+</div></div>';
        
                print '<div id="property_page_content" class="elements_container">
                <div class="property_page_content_wrapper">'. stripslashes($content).'</div>
                <div class="add_me_new_row">+</div></div>';
        
                print '<div id="property_page_sidebar_right" class="elements_container">
                <div class="property_page_content_wrapper">'. stripslashes($sidebar_right).'</div>
                <div class="add_me_new_row">+</div></div>';
    ...
    print ' <div class="estate_option_row_submit">
    <div id="save_prop_design">save me</div>
    ...
    foreach($design_elements as $key=>$value){
        print '<div class="prop_page_design_el_modal" data-tip="'.$value.'">'.$value.'</div>';
    }
    ...
    print '<div class="modal fade" tabindex="-1" role="dialog" id="modal_el_options">
        <div class="modal_el_options_content"></div>
