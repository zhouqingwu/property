		...
		$display.='
              ...
              <h3 class="widget-title-sidebar"  id="register-div-title">'.__('Register','wpestate').'</h3>
                <div class="login_form" id="register-div">
                    ...
                    $display.='<input type="checkbox" name="terms" id="user_terms_register_wd"><label id="user_terms_register_wd_label" for="user_terms_register_wd">'.__('I agree with ','wpestate').'<a href="'.get_terms_links().'" target="_blank" id="user_terms_register_topbar_link">'.__('terms & conditions','wpestate').'</a> </label>';
